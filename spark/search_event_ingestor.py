...
sparkSession = SparkSession.builder \
    ...
    .getOrCreate()
delta_path="hdfs://192.168.1.10:9820/delta/stream/flight_search"
checkpoint_url= "hdfs://192.168.1.10:9820/delta/stream/checkpoints/flight_search"
def ingest_search_event():
    ...
    stream\
        .select(col("timestamp").alias("searched_at"),from_json(col("value").cast(StringType()),schema).alias("json"))\
        .select(col("searched_at"),
